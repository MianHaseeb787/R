...
import 'package:rms/Inventory_screen.dart';
            ...
            child: ListBody(
              children: <Widget>[
                TextField(
                  ...
                  decoration:
                      InputDecoration(hintText: 'TRN', label: Text('TRN')),
                ),
                TextField(
                  controller: taxController,
                  decoration:
                      InputDecoration(hintText: 'Tax', label: Text('Tax')),
                  keyboardType: TextInputType.number,
                ),
                SizedBox(height: 10),
                Text('Current TRN: ${currentValues.trn}'),
                Text('Current Tax: ${currentValues.tax}'),
              ],
            ),
          ),
          actions: <Widget>[
            ...
            TextButton(
              child: const Text('Save'),
              onPressed: () async {
                int newTax = int.tryParse(taxController.text) ?? 0;

                Gvalues updatedValues = Gvalues(
                  tax: newTax,
