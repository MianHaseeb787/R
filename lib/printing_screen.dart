    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: PdfPreview(
          ...
          build: (format) => _generatePdf(format, 'customer bill'),
        ),
      ),
    );
  }
  ...
  Future<Uint8List> _generatePdf(PdfPageFormat format, String title) async {
    ...
    pdf.addPage(
      pw.Page(
        ...
        build: (context) {
          final tax = boxGvalues.getAt(0)!.tax;
          final trn = boxGvalues.getAt(0)!.trn;

          final double tax100 = tax / 100;
          return pw.Column(
